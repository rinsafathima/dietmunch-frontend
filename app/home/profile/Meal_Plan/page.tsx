        ...
        <div>  
            <div className="bg-gradient-to-r from-emerald-200 to-teal-300 flex"> 
                <section className="body-font overflow-hidden p-6">
                    ...
                    <div className="h-48 w-[650px] bg-emerald-100 rounded-lg ml-12 mt-5  ">
                        <div className="p-[8px]"> </div>
                        <h1 className="font-montserrat text-4xl text-cyan-800  font-medium text-center ml-40 mr-40">Monday</h1>
                    </div>

                    <div className="w-[650px] h-48 bg-emerald-300 rounded-lg ml-12 mt-5  ">
                        <div className="p-[8px]"> </div>
                        <h1 className="font-montserrat text-4xl text-cyan-800  font-medium text-center ml-40 mr-40">Tuesday</h1>
                    </div>

                    <div className="h-[405px] w-64 bg-green-400 rounded-lg mr-20 ml-[725px] -mt-[405px]">
                        <div className="p-[8px]"></div>
                        <h1 className="font-montserrat text-4xl  text-cyan-800 font-medium text-center ml-10 mr-10">Friday</h1>
                    </div>

                    <div className="h-[400px] w-64 bg-teal-500 rounded-lg ml-12 mt-5 ">
                        <div className="p-[8px]"> </div>
                        <h1 className="font-montserrat text-4xl font-medium  text-cyan-900 text-center ml-7 mr-7">Wednesday</h1>
                    </div>
