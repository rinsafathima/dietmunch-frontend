    ...
    <div className="bg-gradient-to-r from-emerald-200 to-teal-300 flex">
      <div className="h-fit w-3/5 rounded-lg mt-0 mr-16 ml-20">
        <section className="body-font overflow-hidden">
          <div className=" h-96 w-64 bg-sky-100 rounded-lg mt-20 mb-7 mr-20 ml-8">
            <div className="w-56 h-56 rounded-full mb-5 ml-4 mt-4 inline-flex items-center justify-center bg-white text-gray-500">
            ...
            <div className="mt-4 ml-0 mr-5">
              <p className="text-gray-900 text-center text-2xl mt-4 ml-7 font-sans"><b> </b></p>
            </div>
          </div>


          <div className="h-68 w-72 bg-sky-100 rounded-lg mb-14 mr-20 ml-4 ">
      ...
      <div className=" w-11/12 mt-20 mb-14 mr-24 -ml-20 bg-sky-100 rounded-lg p-4 m-4">
