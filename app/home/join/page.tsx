    ...
    <div className="bg-gradient-to-r from-gray-600 to-gray-800 min-h-screen">
     ...
     <section className="text-gray-100 body-font overflow-hidden">
         ...
         <div className="flex flex-col text-center w-full mb-20">
            <h1 className="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-100">Pricing</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-300">You can choose your plan based on you personal preference.</p>
            <div className="flex mx-auto border-2 border-green-500 rounded overflow-hidden mt-6">
                <button className="py-1 px-4 bg-green-500 text-white focus:outline-none">Weekly</button>
        ...
        <div className="h-full p-6 rounded-lg border-2 border-green-500 flex flex-col relative overflow-hidden hover:border-teal-500 transition-colors duration-300 ease-in-out">
          ...
          <p className="flex items-center text-gray-100 mb-2">
            ...
            </span>A limited selection of meal plans
          </p>
          ...
          <p className="text-xs text-gray-500 mt-3">Enjoy delicious, healthy meals tailored to your preferences with our basic plan.</p>
        </div>
        </div>
        ...
        <div className="p-4 xl:w-1/4 md:w-1/2 w-full hover:bg-teal-500 transition-colors duration-300 ease-in-out">
          ...
          <p className="flex items-center text-gray-100 mb-2">
            ...
            </span>Portion control guidance for personalized calorie targets
          </p>
          <p className="flex items-center text-gray-100 mb-6">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" className="w-3 h-3" viewBox="0 0 24 24">
      ...
      <div className="h-full p-6 rounded-lg border-2 border-green-500 flex flex-col relative overflow-hidden hover:border-teal-500 transition-colors duration-300 ease-in-out">
          ...
          <h1 className="text-5xl text-gray-900 leading-none flex items-center pb-4 mb-4 border-b border-gray-200">
            <span>Rs. 17 500</span>
            <span className="text-lg ml-1 font-normal text-gray-100">/mo</span>
          </h1>
          <p className="flex items-center text-gray-600 mb-2">
            ...
            </span>Unlock Personalized Perfection
          </p>
          <p className="flex items-center text-gray-100 mb-2">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" className="w-3 h-3" viewBox="0 0 24 24">
            ...
            </span>All Elite plan features, plus:
          </p>
          <p className="flex items-center text-gray-100 mb-2">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" className="w-3 h-3" viewBox="0 0 24 24">
            ...
            </span>Completely customized meal plans
          </p>
          <p className="flex items-center text-gray-100 mb-2">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" className="w-3 h-3" viewBox="0 0 24 24">
            ...
            </span>In-depth nutritional analysis
          </p>
          <p className="flex items-center text-gray-100 mb-6">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" className="w-3 h-3" viewBox="0 0 24 24">
          ...
          <p className="text-xs text-gray-500 mt-3">Dedicated account manager for personalized support.</p>
        </div>
      </div>
      ...
      <div className="h-full p-6 rounded-lg border-2 border-green-500 flex flex-col relative overflow-hidden hover:border-teal-500 transition-colors duration-300 ease-in-out">
          ...
          <p className="flex items-center text-gray-100 mb-2">
            ...
            </span>All Pro plan features, plus:
          </p>
          <p className="flex items-center text-gray-100 mb-2">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" className="w-3 h-3" viewBox="0 0 24 24">
            ...
            </span>goal setting to promote healthy habits
          </p>
          <p className="flex items-center text-gray-100 mb-2">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" className="w-3 h-3" viewBox="0 0 24 24">
            ...
            </span>Custom reporting and analytics to track progress
          </p>
          <p className="flex items-center text-gray-100 mb-6">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" className="w-3 h-3" viewBox="0 0 24 24">
          ...
          <p className="text-xs text-gray-500 mt-3">Fuel your health and productivity with our premium plan.</p>
        </div>
      </div>
    </div>
    </div>  
